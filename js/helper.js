...
*/
var HTMLheaderName = '<div class="flex-box headerName"><h1 id="name">%data%</h1></div>';
var HTMLheaderRole = '<div class="flex-box role">%data% </div>';

var HTMLcontactGeneric = '<li class="flex-item"><span class="orange-text">%contact%</span><span class="white-text">%data%</span></li>';
var HTMLmobile = '<li class="flex-item contact"><span class="orange-text">Mobile</span><span class="white-text">%data%</span></li>';
var HTMLemail = '<li class="flex-item contact"><span class="orange-text">E-mail</span><span class="white-text">%data%</span></li>';
var HTMLtwitter = '<li class="flex-item contact"><span class="orange-text">Twitter</span><span class="white-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item contact"><span class="orange-text">Github</span><span class="white-text">%data%</span></li>';
...
var HTMLschoolName = '<a href="#" id="schoolName">%data%';
...
var HTMLonlineTitle = '<a href="#" id="onlineName">%data%';
var HTMLonlineSchool = '%data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<br><a href="#" id="onlineURL">%data%</a>';
